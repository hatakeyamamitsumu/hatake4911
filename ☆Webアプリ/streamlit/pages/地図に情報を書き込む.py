...
if app_selection == "地図のおすすめスポットにピンを立てる":
    ...
    # 地図を作成
    m = folium.Map(width=900, height=300,location=[35.0000, 135.0000], zoom_start=9)
    time.sleep(0.5)
    ...
    st_folium(m, width=700, height=500,zoom_controle=False)
    time.sleep(0.5)
    st_folium(m, width=700, height=500,zoom_controle=True)
