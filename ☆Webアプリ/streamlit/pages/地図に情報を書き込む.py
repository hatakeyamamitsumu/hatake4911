...
if app_selection == "地図にピンを立て、コメントをつけて保存する":
    ...
    latitude_input_1 = st.sidebar.number_input("１0０ｍ刻みで指定",value=latitude_slider,step=0.01,format="%.4f",key="latitude")
    latitude_input = st.sidebar.number_input("１０ｍ刻みで指定",value=latitude_input_1,step=0.001,format="%.4f",key="latitude")
