...
if app_selection == "地図にピンを立て、コメントをつけて保存する":
    ...
    # 緯度の入力方法を選択
    latitude_slider = st.sidebar.slider("緯度を選択してください", min_value=24.210000, max_value=45.320000, value=35.689500, step=0.000001)
    latitude_input = st.sidebar.number_input("緯度を入力してください", value=latitude_slider, step=0.000001, format="%.6f", key="latitude")

    # 経度の入力方法を選択
    longitude_slider = st.sidebar.slider("経度を選択してください", min_value=122.550000, max_value=139.180000, value=139.691700, step=0.000001)
